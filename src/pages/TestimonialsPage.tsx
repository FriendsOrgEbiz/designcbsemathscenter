  ...
  const testimonials: Testimonial[] = [
    {
      ...
      subject: "Mathematics",
      rating: 5,
      text: "The mathematics filling method taught at DEISGN helped me understand complex concepts that seemed impossible before. I secured 98/100 in my board exams and got selected in my dream engineering college. The teachers are extremely supportive and the study materials are comprehensive.",
    ...
    },
    {
      ...
      subject: "Science",
      rating: 5,
      text: "The teachers are incredibly supportive and the study materials are comprehensive. My science scores improved dramatically after joining the institute. The regular test batches helped me identify my weaknesses and work on them. I scored 95% in Science and attribute my success to DEISGN's systematic approach.",
    ...
    },
    {
      ...
      subject: "Physics",
      rating: 5,
      text: "Physics was always challenging for me until I joined DEISGN. The teachers explain complex topics with such clarity that even the most difficult concepts become easy to understand. The practice problems and regular tests are extremely helpful. I'm confident of scoring well in my board exams.",
    ...
    },
    {
      ...
      subject: "Mathematics",
      rating: 5,
      text: "I joined DEISGN in class 8 to build a strong foundation in mathematics. The teachers are excellent and make learning fun. The filling method has helped me develop a structured approach to problem-solving. I look forward to continuing my education here through high school.",
    ...
    <div className="pt-24 pb-16">
      ...
      <div className="bg-primary-800 py-12 mb-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-white">Student Testimonials</h1>
            <p className="text-primary-100 mt-2">Success stories from our students</p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto mt-12 bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Submit Your Testimonial</h3>
            </div>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <Star size={24} className="text-gray-300 hover:text-accent-500" />
                    </button>
                  ))}
                </div>
              </div>
