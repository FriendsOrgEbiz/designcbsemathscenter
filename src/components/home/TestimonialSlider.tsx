...
const testimonials: TestimonialProps[] = [
  {
    ...
    text: "The mathematics filling method taught at DESIGN helped me understand complex concepts that seemed impossible before. I secured 98/100 in my board exams.",
    rating: 5,
          ...
          <div className="flex justify-center mt-8 space-x-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors ${index === currentTestimonial ? 'bg-primary-600' : 'bg-gray-300'
                  }`}
